      ...
      <div className="card mb-8">
        ...
        {loading ? (
          ...
          <>
            {/* Sales Trend Chart */}
            <div className="card mb-8">
              <h2 className="text-lg font-heading font-semibold mb-2 text-secondary">Sales Trend</h2>
              <Line
                data={{
            ...
            {/* By Shopkeeper */}
            <div className="card mb-8">
              <h2 className="text-lg font-heading font-semibold mb-2 text-secondary">Sales by Shopkeeper</h2>
              <Bar
                data={{
            ...
            {/* By Product */}
            <div className="card mb-8">
              <h2 className="text-lg font-heading font-semibold mb-2 text-secondary">Sales by Product</h2>
              <Bar
                data={{
            ...
            {/* By Payment Method */}
            <div className="card mb-8">
              <h2 className="text-lg font-heading font-semibold mb-2 text-secondary">Sales by Payment Method</h2>
              <Pie
                data={{
