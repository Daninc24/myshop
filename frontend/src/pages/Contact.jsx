...
export default function Contact() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 py-12 bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <section className="max-w-xl w-full flex flex-col gap-4 bg-blue-50 dark:bg-gray-800 p-6 rounded-xl shadow mb-8">
      ...
      <section className="max-w-xl w-full mb-8">
        <h2 className="text-xl font-semibold mb-2 text-blue-800 dark:text-yellow-300">Send Us a Message</h2>
        <form className="flex flex-col gap-3 bg-white dark:bg-gray-900 p-4 rounded-lg shadow" onSubmit={e => {e.preventDefault(); alert('Message sent!')}}>
      ...
      <section className="max-w-xl w-full mb-4">
        <h2 className="text-xl font-semibold mb-2 text-blue-800 dark:text-yellow-300">Find Us</h2>
